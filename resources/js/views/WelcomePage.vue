          ...
          <div class="col-lg-6">
            ...
            <div class="mb-5 mb-lg-0 text-center text-lg-start">
              ...
              <p class="lead fw-normal text-muted mb-5">
                Launch your mobile app landing page faster with this free, open source
                            ...
                            <div class="device-wrapper">
                                <div class="device" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                    <div class="screen bg-black">
                                        ...
                                        <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 100%"><source src="../../../public/welcomepage/assets/img/demo-screen.mp4" type="video/mp4" /></video>
                                    </div>
                                </div>
                            </div>
                        </div> -->
 ...
 components: {
  ...
  methods: {
    imageLocation(){
        ...
        return require('../../../public/welcomepage/assets/img/sksu1.png');
    }
  },
